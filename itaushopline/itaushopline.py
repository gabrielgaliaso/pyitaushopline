...
if __name__ == '__main__':
    ...
    itaushopline.process(pedido=300, valor=100.50, observacao='', nome='GABRIEL GALIASO DE ALMEIDA', 
        codigo_inscricao='02', numero_inscricao='00000000000', cep='14015130', 
        endereco='R BERNARDINO DE CAMPOS 1001 SALA 110', bairro='HIGIENOPOLIS', cidade='RIBEIRAO PRETO', estado='SP', 
